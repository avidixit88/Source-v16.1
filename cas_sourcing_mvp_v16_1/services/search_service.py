...
def _source_label(result: SearchResult, page_has_cas: bool) -> str:
    if page_has_cas:
        return "expanded_product_link_v16_cas_page"
    return "expanded_product_link_v16"
...
def discover_product_links_from_page(result: SearchResult, cas_number: str, timeout: int = 12, max_links: int = 8) -> list[SearchResult]:
    ...
    v16 fixes a key issue found in testing: many supplier CAS result pages link to
    ...
    if page_has_cas and _STRONG_PRODUCT_PATH_RE.search(resp.url) and not _BAD_LINK_RE.search(resp.url):
        ...
        candidates.append((95, SearchResult(
            ...
            source="expanded_landing_product_v16",
    ...
    for a in soup.find_all("a", href=True):
        ...
        # v16: product slugs may omit CAS, but the surrounding result card must carry
        ...
        candidates.append((score, SearchResult(
            ...
            source=("expanded_product_link_v16_cas_context" if context_has_cas else "expanded_product_link_v16_needs_identity_check"),
